      ...
      <v-col cols="4">
        <div class="">
          <div>
            ...
            <p>Enfono Technologies Pvt. Ltd</p>
            <p>Judgemukku, Kakkanad,</p>
            <p>Kochi - 682021</p>
            <p>
              No. 6/858-M, 2nd Floor, <br />Suite No.598 Valamkottil Towers,
            </p>
            <p>
              <svg
      ...
      <v-row>
        <v-col cols="3">
          <div class="column-content">
            ...
            />
            <p>
              Enfono is committed to developing innovative and customized
              solutions for our customers, keeping quality and affordability as
              the highest concern.
            </p>
          </div>
        </v-col>
            ...
            <p class="my-2">
              ...
              >
                ...
                <path
                  d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"
                /></svg
              >ERP Software Administration Service
            </p>
            <p class="my-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
