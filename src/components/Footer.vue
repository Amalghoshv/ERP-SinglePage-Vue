          ...
          <div>
            ...
            <div class="">
              ...
              >
                ...
                /></svg>contact@enfono.com
            </div>
          </div>
        </div></v-col
      >
      <v-col cols="12" lg="8" md="6" class="mx-auto">
        <div>
          <v-container>
          ...
          <div class="column-content">
            ...
            <p class="my-2">
              ...
              >
                ...
                /></svg>ERP Software Implementation
            </p>
            <p class="my-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
...
@media only screen and (max-width: 767px) {
  h3 {
    font-size: 18px; /* Adjust the font size for h2 headings */
  }
  p {
